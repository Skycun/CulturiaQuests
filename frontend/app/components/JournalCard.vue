<template>
    <div class="flex flex-col items-center w-full max-w-[120px] mx-auto">
        ...
        <div class="relative w-full aspect-square flex flex-col justify-end bg-white transition-all duration-300 rounded-t-3xl rounded-b-none"
            :class="[
                isCompleted
        ...
        <div class="w-full h-2 bg-gray-200 relative z-40">
            <div class="h-full transition-all duration-500 ease-out rounded-l-none"
